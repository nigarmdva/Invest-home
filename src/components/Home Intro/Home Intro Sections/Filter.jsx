  ...
  return (
    <>
      <div className="flex items-center ml-[3rem]">
        <div className="text-[var(--primary-color)] w-[994px] text-[1rem] font-[400] flex items-center py-[0.3rem] bg-[var(--white)]  border border-[#F0EEEE] shadow-[0px_3px_15px_0px_rgba(0,_0,_0,_0.05)] rounded-l-[0.5rem]">
